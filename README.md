...
Visualization of the A\* pathfinding algorithm exploring nodes and finding the optimal path.

![A* Preview](public/images/astart.png)

---

### Dijkstra's Algorithm

Step-by-step visualization of Dijkstra’s algorithm computing the shortest path.

![Dijkstra Preview](public/images/dijkstra.png)

---

### Recursive Division Maze

Automatically generated maze using the recursive division technique.

![Recursive Division Preview](public/images/recursiveDivision.png)

---

### Stair Pattern Maze

Simple stair-like pattern used for testing algorithm behavior.

![Stair Pattern Preview](public/images/stairPattern.png)
